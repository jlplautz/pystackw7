...
from core.extrato.models import Valores
...
def home(request):
    ...
    percentual_gastos_essenciais = calcula_equilibrio_financeiro()
    percentual_gastos_nao_essenciais = calcula_equilibrio_financeiro()
...
def cadastrar_banco(request):
    ...
    conta = Conta(
        apelido=apelido, banco=banco, tipo=tipo, valor=valor, icone=icone
    )
